...
// import photo17 from 'C:/Users/HP/Desktop/Projects/my-project/src/assets/foto16.jpg'

const Footer = () =>{
    return (
        <div className='w-full max-h-[600px]'>
            
<footer class="p-4  sm:p-6  bg-[url('C:/Users/HP/Desktop/Projects/my-project/src/assets/foto16.jpg')]">
    <div class="md:flex md:justify-around">
        ...
        <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
                <h2 class="mb-6 text-xl text-mysticRed font-bold ">Location</h2>
                <p className='text-white text-sm'>3517 W. Gray St. Utica, <br /> Pennsylvania 57867</p>
                
            </div>
            <div>
                <h2 class="mb-6 text-xl text-mysticRed font-bold ">Call Us</h2>
                <p className='text-white text-sm'>(252) 555-0126</p>
                <p className='text-white text-sm'>info@youremai.com</p>
            </div>
            <div>
            <h2 class="mb-6 text-xl text-mysticRed font-bold ">Follow  Us</h2>
    ...
    <hr class="my-6 border-white sm:mx-auto dark:border-whitelg:my-8" />
    <div class="sm:flex sm:items-center sm:justify-between">
        <span class="text-sm text-white sm:text-center ">© Copyright 2021. All Right Reserved By Ojjomedia 
        </span>
